...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="" class="navbar-brand">
          <img src="../admin/gambar/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2014-2021 Hotel Hebat</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
