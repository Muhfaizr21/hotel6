        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="assets/index3.html" class="navbar-brand">
                    <img src="../admin/gambar/logo.png" alt="Rhotel Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="../admin/gambar/g1.jpg" alt="First slide"
                                                height="450">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="../admin/gambar/g2.jpg" alt="Second slide"
                                                height="450">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="../admin/gambar/g3.jpg" alt="Third slide"
                                                height="450">
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fea-base" style="display: flex;">
                                        <div class="fea-box">
                                            ...
                                            <p>Di Hotel Hebat Ada Banyak Tipe Kamar Yang Bisa Anda Pilih<br>Sesuai
                                                Kebutuhan Anda<br>Serta
                                                Hotel Hebat Juga Mempunyai Spot Kamar<br>Dengan Pemandangan Yang
                                                Indah<br>Yang Akan Sangat
                                                Menarik Untuk Dilihat!!</p>
                                        </div>
                                        <div class="fea-box">
                                            <img src="../admin/gambar/icon2.png" alt="" width=100" height=100">
                                            <h3>Pelayanan Yang Mengutamakan Anda</h3>
                                            <p>Di Hotel Hebat Anda Adalah Prioritas Kami <br>Jika Ada Ketidaknyamanan
                                                Ataupun Hal yang
                                                Mengganggu<br> Atau Anda membutuhkan<br> Sesuatu Resepsionis Kita Akan
                                                Terus Siap Bagi Anda 24
                                                Jam!</p>
                                        </div>
                                        <div class="fea-box">
                                            <img src="../admin/gambar/icon3.png" alt="" width=100" height="100">
                                            <h3>Harga Terjangkau</h3>
                                            <p>Di Hotel Hebat Anda Bisa Memilih Berbagai Macam kamar<br> Dengan Harga
                                                Yang Relatif
                                                Terjangkau<br> Tergantung Pada Tipe Kamar Hotel Yang Anda Pilih,<br>Jadi
                                                Gausah Takut Kemahalan
                                                Nih Kalau Di Hotel Hebat!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    <form action="cetak.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_tamu" placeholder="Nama Users">
                            <?php
              $no = 1;
              include '../koneksi.php';
              ...
              while ($data = mysqli_fetch_array($sql)) {
                ...
                ?>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary"><a href="cetak.php"></a> cetak</button>
                        </div>
                    </form>
                </div>
</body>
